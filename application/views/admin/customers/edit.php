...
<div class="page-header d-flex justify-content-between">
    ...
    <div class="page-rightheader text-right">
        <div class="btn-list">
            <a href="<?php echo base_url(); ?>admin/customers" class="btn btn-primary"><i class="fe fe-arrow-left"></i> Go Back</a>
        </div>
    </div>
</div>
<div class="row">
                ...
                <form>
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-6 mb-2">
                            ...
                            <textarea class="short_notes form-control"><?php echo $customer->short_note; ?></textarea>
...
<script src="<?php echo base_url(); ?>admin_assets/app/js/customers/edit.js?version=<?php echo uniqid(); ?>"></script>