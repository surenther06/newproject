<aside class="app-sidebar">
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <!-- <li class="slide">
            <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo base_url(); ?>colors">
                ...
                <span class="side-menu__label">Colors</span>
            </a>
        </li> -->
        <!-- <li class="slide">
            <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo base_url(); ?>customers">
