...
<div class="page-header d-flex justify-content-between">
    ...
    <div class="page-rightheader text-right">
        <div class="btn-list">
            <a href="<?php echo base_url(); ?>mentors" class="btn btn-primary"><i class="fe fe-arrow-left"></i> Go Back</a>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add Mentors</h3>
            </div>
                ...
                <form>
                    <div class="row row-sm">
                        <div class="col-lg-6 mb-2">
                            ...
                            <span class="name_error" style="font-size: 12px; color: red; margin-top: 5px; display: none;">Please enter college name *</span>
                        </div>
                        <div class="col-lg-6 mb-2">
...
<script src="<?php echo base_url(); ?>admin_assets/app/js/mentors/add.js?version=<?php echo uniqid(); ?>"></script> 