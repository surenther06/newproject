                       ...
                       <!-- <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="property-box">
                                <div class="property-image">
                                    ...
                                    <div class="bottom-property">
                                        <div class="d-flex">
                                            <div>
                                                <h5><a href="single-property-6.html">Artificial inteligence</a></h5>
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                            <div class="property-box">
                                <div class="property-image">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/robotics.jpg" class="bg-img" alt="">
                                        <div class="labels-left">
                                            <span class="label label-shadow">Exlucive</span>
                                        </div>
                                    </a>
                                    <div class="bottom-property">
                                        <div class="d-flex">
                                            <div>
                                                <h5><a href="single-property-6.html">Robotics</a></h5>
                                                <h6>20,200 <small>/ start from</small></h6>
                                            </div>
                                            <button type="button" class="btn btn-gradient color-6 mt-3"
                                                onclick="document.location='single-property-8.html'">Details</button>
                                        </div>
                            ...
                            <div class="feature-wrapper">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-3">
                                        <div class="feature-left ">
                                            <div class="property-details">
                                                <span class="font-roboto">City</span>
                                                <a href="single-property-8.html">
                                    ...
                                    <div class="col-xl-8 col-lg-9 order-md">
                                        <div class="feature-image">
                                            <img src="assets/images/property/pg2.jpg" alt="" class="bg-img">
                                            <h4>SGV COLLEGE</h4>
                                            <span class="box-color"></span>
                                            <span class="signature">
                                                <img src="assets/images/signature/1.png" alt="">
   ...
   <!-- <section class="my-gallery gallery-6">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="title-1 color-6">
                        <span class="label label-gradient color-6">Visit</span>
                        <h2>Our Visit in These Cities</h2>
                        <hr>
                    </div>
                    <div class="row">
            ...
            <div class="row">
                <div class="col">
                    <div class="title-3">
                        ...
                        <p class="font-roboto">Residences can be classified into different type of housing tenure can
                            used for same physical type.</p>
                    </div>
                            ...
                            <div class="row our-client">
                                ...
                                <div class="col-md-6">
                                    <div class="client-right">
                                        <p class="font-roboto">
                                            Luxury real estate is sometimes use as store value. Some luxury units in
                                            London and New York City. Residences can be classified by
                                            and how they are connected to neighbouring residences and land. Different
                                            types of housing tenure can be used for
                                            the same physical type. Residences can be classified by and how they are
                                            connected to neighbouring residences and land. </p>

                                        <h3>Wes Yabinlatelee</h3>
                                        <h6>Our Customer</h6>
